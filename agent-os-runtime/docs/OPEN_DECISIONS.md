...
| 3 | **Tool Result Artifactization** | done-local @ 2026-04-29 (pytest + ruff passed, commit pending) | 长 tool result 自动外置为 artifact、`<artifact ref>` 替代原文进 history、prompt budget 内只保留摘要 + ref | Battle 2 |
