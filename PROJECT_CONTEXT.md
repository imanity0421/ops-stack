...
**当前约定**：整个 **`ops-stack`** 作为 **单一 Git 仓库（monorepo）** 推送到 GitHub（如 `imanity0421/ops-stack`），子目录 `video-raw-ingest`、`ops-knowledge`、`ops-distiller-forge`、`ops-agent`、`pipeline-demo` 均包含在同一远程中。
