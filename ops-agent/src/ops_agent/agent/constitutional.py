...
if TYPE_CHECKING:
    from ops_agent.manifest_loader import AgentManifestV1

# 与路线图 P1-3 及测试文档对齐；改文案须同步 ``docs/examples/constitutional_test_cases.md``。
MARKER = "【系统宪法·冲突解决序】"
...
4. **领域 SOP/规则** — Graphiti/配方手册/交付 handoff/经核准的话术等**可执行流程**。
5. **Asset 参考案例** — 语感、结构、段落组织参考；**不能**覆盖 1 或冒称事实。

**特别判定**
- 若用户要求**违反 1** 的文案/策略：须**拒绝**并说明原因，不得以「按用户来」执行。
